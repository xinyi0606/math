...
>
> 最终交付装配：**暂不建议**，原因是数字尚未冻结，且Q3正式正文图和参考文献外部核验尚未完成。
...
8. **PASS-08 图文范围一致**：正文嵌入已审核的Q1、Q2和Q4中文600 dpi图；Q4七张图均能追溯到逐图证据索引和验证报告，Q3继续明确保留待绘位置。
...
11. **PASS-11 正文引用完整**：全文19个图片链接均可解析到本地文件；7张Q4正文PNG均为4320像素宽、约600 dpi，逐张视觉复核未见中文缺字、裁切、图例遮挡或连续色阶缺少色标。
...
2. Q3正式正文图尚未生成；现阶段只能审计待插图说明及其数据源，不能审计最终成图中的数值和标注。
...
6. Q4图包的PDF存在中文字体嵌入警示；正文优先使用已核验的600 dpi PNG，若转为矢量排版应优先采用SVG并再次检查。
